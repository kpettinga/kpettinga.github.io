  ...
  return (
    <>
            ...
            <div className="lg:col-span-4 order-1 lg:order-2">
              ...
              <ul>
                {project.stack.map((tech) => (
                  <li className="text-base font-mono">
                    <mark>{tech}</mark>
                  </li>
                ))}
              </ul>
      ...
      <Stage id="contact" className="gap-16">
        <a target="_blank" href="https://github.com/kpettinga" className="transition-all opacity-0 -translate-x-16 ease-out group-[.is-visible]/stage:opacity-80 group-[.is-visible]/stage:hover:opacity-100 group-[.is-visible]/stage:translate-x-0 ">
        ...
        <a target="_blank" href="https://x.com/KirkPettinga" className="transition-all opacity-0 -translate-x-16 ease-out group-[.is-visible]/stage:opacity-80 group-[.is-visible]/stage:hover:opacity-100 group-[.is-visible]/stage:translate-x-0 ">
        ...
        <a target="_blank" href="https://www.linkedin.com/in/kirk-pettinga/" className="transition-all opacity-0 -translate-x-16 ease-out group-[.is-visible]/stage:opacity-80 group-[.is-visible]/stage:hover:opacity-100 group-[.is-visible]/stage:translate-x-0 ">
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 512 512"><path fill="currentColor" d="M464 0h-416c-26.4 0-48 21.6-48 48v416c0 26.4 21.6 48 48 48h416c26.4 0 48-21.6 48-48v-416c0-26.4-21.6-48-48-48zM192 416h-64v-224h64v224zM160 160c-17.7 0-32-14.3-32-32s14.3-32 32-32c17.7 0 32 14.3 32 32s-14.3 32-32 32zM416 416h-64v-128c0-17.7-14.3-32-32-32s-32 14.3-32 32v128h-64v-224h64v39.7c13.2-18.1 33.4-39.7 56-39.7 39.8 0 72 35.8 72 80v144z"></path></svg>
        </a>
        <a target="_blank" href="mailto:kirk.pettinga@gmail.com" className="transition-all opacity-0 -translate-x-16 ease-out group-[.is-visible]/stage:opacity-80 group-[.is-visible]/stage:hover:opacity-100 group-[.is-visible]/stage:translate-x-0 ">
          <svg width="64px" height="64px" viewBox="0 -2.5 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="currentColor"><g transform="translate(-300.000000, -922.000000)" fill="currentColor"><g id="icons" transform="translate(56.000000, 160.000000)"><path d="M262,764.291 L254,771.318 L246,764.281 L246,764 L262,764 L262,764.291 Z M246,775 L246,766.945 L254,773.98 L262,766.953 L262,775 L246,775 Z M244,777 L264,777 L264,762 L244,762 L244,777 Z" id="email-[#1573]"></path></g></g></svg>
        </a>
      </Stage>
    </>
  );
